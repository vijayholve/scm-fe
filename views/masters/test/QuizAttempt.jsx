...
const QuizAttempt = () => {
    ...
    const fetchQuiz = async () => {
        try {
            setLoading(true);
            const response = await api.get(`api/quiz/student/attempt/${quizId}?studentId=${userDetails.getUserId()}`);
    ...
    const handleSubmitQuiz = async (isAutoSubmit = false) => {
        try {
            ...
            const response = await api.post('api/quiz/student/submit', submissionData);
