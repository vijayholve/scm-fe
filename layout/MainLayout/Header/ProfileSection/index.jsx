...
// import StudentProfile from 'views/pages/StudentProfile';
...
const rawUtilities = {
  ...
  children: [
    // ...other menu items...
    // Add this at the end or wherever you want:
    ...(isStudent
      ? [
          {
            id: 'STUDENT_PROFILE',
                ...
                <MainCard border={false} elevation={16} content={false} sx={{ boxShadow: theme.shadows[16] }}>
                  <Box sx={{ p: 2, pb: 0 }}>
                    ...
                    <OutlinedInput
                      ...
                      placeholder="Search settings & accounts"
                      startAdornment={
                          ...
                          <Grid container spacing={3} direction="column">
                            <Grid item>
                              <Grid item container alignItems="center" justifyContent="space-between">
                                <Grid item>
                                  <Typography variant="subtitle1">Send Alerts </Typography>
                                </Grid>
                                <Grid item>
                                  <Switch
                                    color="primary"
