...
const NotificationList = ({ notificationList = [] }) => {
  ...
  return (
    ...
    //         <Typography variant="subtitle2">It is notified you that you were absent for 11/06/2025</Typography>
    //       </Grid>
    //       <Grid item xs={12}>
    //         <Grid container>
    //           <Grid item>
    ...
    //         <Avatar alt="John Doe" src={User1} />
    //       </ListItemAvatar>
    //       <ListItemText primary={<Typography variant="subtitle1">{user.firstName + " " + user.lastName}</Typography>} />
    //       <ListItemSecondaryAction>
    //         <Grid container justifyContent="flex-end">
    //           <Grid item xs={12}>
    //             <Typography variant="caption" display="block" gutterBottom>
    ...
    //     <Grid container direction="column" className="list-container">
    //       <Grid item xs={12} sx={{ pb: 2 }}>
    //         <Typography variant="subtitle2">You are absent for today i.e. 11/06/2025 </Typography>
    //       </Grid>
    //       <Grid item xs={12}>
    //         <Grid container>
    //           <Grid item>
    ...
    >
      {notificationList?.map((notification, idx) => (
        <ListItemWrapper key={notification.id || idx}>
          <ListItem alignItems="center">
            <ListItemText
              primary={notification?.entityType || 'Notification'}
